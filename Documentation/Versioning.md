...
The Milestone 5 package release target is `0.5.0`. Milestone 0 remains an untagged development baseline; Milestones 1 through 4 are tagged `0.1.0`, `0.2.0`, `0.3.0`, and `0.4.0`. Package versions follow semantic versioning as later milestones add behavior and eventually stabilize the public API.
