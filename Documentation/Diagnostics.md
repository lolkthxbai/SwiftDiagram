...
| SWD1040, SWD1042-SWD1048 | error | Malformed extension, attribute, or method modifier syntax |
| SWD2001 | error | Duplicate type declaration |
| SWD2002 | error | Duplicate member |
| SWD2003 | error | Unknown relationship source |
| SWD2004 | error | Unknown relationship target where a known declaration is required |
...
| SWD2018 | error | Extension target is not a named type |
